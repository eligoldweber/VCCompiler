...
// Jasmin ASSEMBLY INSTRUCTIONS
  ...
  // Array Instructions(added); 
  
  NEWARRAY = "newarray",  //make new array
    
  FASTORE  = "fastore",   //store float
  IASTORE  = "iastore",   //store int
  BASTORE  = "bastore",   //store boolean
  
  FALOAD   = "faload",    //load float
  IALOAD   = "iaload",    //load int
  BALOAD   = "baload";    //load boolean
